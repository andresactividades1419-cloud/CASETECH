...
class Recipe(Base):
    ...
    __table_args__ = (
        UniqueConstraint("tipo_caseton_id", "material_id", name="uq_receta_tipo_material"),
    ...
    cantidad_por_unidad: Mapped[Decimal] = mapped_column(
    ...
    # Relaciones
    tipo_caseton: Mapped["ProductType"] = relationship("ProductType", back_populates="recetas")
