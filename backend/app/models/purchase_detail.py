...
class PurchaseDetail(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("precio_unitario >= 0", name="ck_detalle_compras_precio_non_negative"),
    )
    ...
    compra_id: Mapped[int] = mapped_column(
        BigInteger, ForeignKey("compras.id", ondelete="CASCADE"), nullable=False, index=True
    )
    ...
    material: Mapped["Material"] = relationship("Material", back_populates="detalle_compras")
